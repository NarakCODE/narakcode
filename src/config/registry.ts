export const registryConfig = {
   ...
   * @example "@nrcode" - Users can install components with: `npx shadcn add @nrcode/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@nrcode",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://narakcode.dev/r/{name}.json" resolves to "https://narakcode.dev/r/wheel-picker.json"
  ...
  namespaceUrl:
    ...
    "https://narakcode.dev/r/{name}.json",
}
