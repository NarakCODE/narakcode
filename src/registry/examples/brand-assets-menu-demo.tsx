...
export default function BrandAssetsMenuDemo() {
  return (
    <div className="flex flex-col items-center gap-4">
      <BrandAssetsMenu
        logomark={<NarakCODEMark />}
        logomarkSVG={LOGOMARK_SVG}
        logotypeSVG={LOGOTYPE_SVG}
        brandGuidelinesURL="https://narakcode.dev/blog/narakcode-brand"
        brandAssetsURL="https://assets.narakcode.dev/narakcode-brand.zip"
      >
        <Link href="/" aria-label="Home">
          <NarakCODEMark className="h-8 text-foreground" />
        </Link>
      </BrandAssetsMenu>
...
const LOGOMARK_SVG =
  '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 256 128"><path fill="currentColor" d="M32 128H0V0h32v128ZM96 128H64V0h32v128ZM64 96H32V32h32v64ZM256 32h-96v64h96v32H128V0h128v32Z"/></svg>'
...
function NarakCODEMark(props: React.ComponentProps<"svg">) {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="M64 256H0V0h64v256ZM192 256H128V0h64v256ZM128 192H64V64h64v128ZM512 64h-192v128h192v64H256V0h256v64Z"
      />
    </svg>
  )
}
