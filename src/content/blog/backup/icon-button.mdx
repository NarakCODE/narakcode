...
image: /images/blog/icon-button.png
...
> **⚠️ Notes** : The following guide is for Tailwind v4. If you are using Tailwind v3, use `shadcn@2.3.0`.
...
If you want to animated the icon (Recommend):
