...
image: https://assets.narakcode.dev/images/blog/dot-grid-spotlight.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/dot-grid-spotlight.json"
/>
...
```bash
npx shadcn@latest add @nrcode/dot-grid-spotlight
```
