...
image: https://assets.narakcode.dev/images/blog/spinning-circular-text.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/spinning-circular-text.json"
/>
...
```bash
npx shadcn@latest add @nrcode/spinning-circular-text
```
...
```tsx
<SpinningCircularText text="Built with care by narakcode • " />
```
