...
image: https://assets.narakcode.dev/images/blog/share-menu.webp
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/share-menu.json"
/>
...
```bash
npx shadcn@latest add @nrcode/share-menu
```
...
```tsx
<ShareMenu title="narakcode.dev" url="https://narakcode.dev" />
```
