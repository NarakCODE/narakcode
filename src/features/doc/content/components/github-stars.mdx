...
image: https://assets.narakcode.dev/images/blog/github-stars.webp?t=1779078388
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/github-stars.json"
/>
...
```bash
npx shadcn@latest add @nrcode/github-stars
```
...
```tsx
<GithubStars repo="narakcode/chanhdai.com" stargazersCount={2050} />
```
