...
image: https://assets.narakcode.dev/images/blog/testimonial-2.webp
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/testimonial-2.json"
/>
...
```bash
npx shadcn@latest add @nrcode/testimonial-2
```
