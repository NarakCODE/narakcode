...
image: https://assets.narakcode.dev/images/blog/elastic-slider.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/elastic-slider.json"
/>
...
```bash
npx shadcn@latest add @nrcode/elastic-slider
```
