...
image: https://assets.narakcode.dev/images/blog/scroll-fade-effect.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/scroll-fade-effect.json"
/>
...
```bash
npx shadcn@latest add @nrcode/scroll-fade-effect
```
