...
image: https://assets.narakcode.dev/images/blog/brand-assets-menu.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/brand-assets-menu.json"
/>
...
```bash
npx shadcn@latest add @nrcode/brand-assets-menu
```
