...
image: https://assets.narakcode.dev/images/blog/github-contributions.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/github-contributions.json"
/>
...
```bash
npx shadcn@latest add @nrcode/github-contributions
```
