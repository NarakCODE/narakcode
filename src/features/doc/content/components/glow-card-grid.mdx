...
image: https://assets.narakcode.dev/images/blog/glow-card-grid.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/glow-card-grid-demo.json"
  customizeUrl="https://narakcode.dev/preview/glow-card-grid-dialkit"
/>
...
```bash
npx shadcn@latest add @nrcode/glow-card-grid
```
