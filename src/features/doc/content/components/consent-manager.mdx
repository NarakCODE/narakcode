...
image: https://assets.narakcode.dev/images/blog/consent-manager.webp
...
<IframeEmbed
  ...
  src="https://react-wheel-picker.narakcode.dev/sponsors"
...
```bash
npx shadcn@latest add @nrcode/consent-manager
```
