...
image: https://assets.narakcode.dev/images/blog/toc-minimap.webp?t=1779078388
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/toc-minimap.json"
/>
...
```bash
npx shadcn@latest add @nrcode/toc-minimap
```
