...
image: https://assets.narakcode.dev/images/blog/chevrons-up-down-icon.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/chevrons-up-down-icon.json"
/>
...
```bash
npx shadcn@latest add @nrcode/chevrons-up-down-icon
```
