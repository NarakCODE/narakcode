...
image: https://assets.narakcode.dev/images/blog/theme-toggle-effect.webp?t=1779078388
...
```bash
npx shadcn@latest add @nrcode/theme-toggle-effect-triangle
```

### Triangle blur

```bash
npx shadcn@latest add @nrcode/theme-toggle-effect-triangle-blur
```

### Circle

```bash
npx shadcn@latest add @nrcode/theme-toggle-effect-circle
```

### Circle blur

```bash
npx shadcn@latest add @nrcode/theme-toggle-effect-circle-blur
```

### Circle blur (top left)

```bash
npx shadcn@latest add @nrcode/theme-toggle-effect-circle-blur-top-left
```

### Polygon

```bash
npx shadcn@latest add @nrcode/theme-toggle-effect-polygon
```

### Polygon gradient

```bash
npx shadcn@latest add @nrcode/theme-toggle-effect-polygon-gradient
```
