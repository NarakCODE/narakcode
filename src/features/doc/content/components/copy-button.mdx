...
image: https://assets.narakcode.dev/images/blog/copy-button.webp?t=1779078388
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/copy-button.json"
/>
...
```bash
npx shadcn@latest add @nrcode/copy-button
```
