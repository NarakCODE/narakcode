...
image: https://assets.narakcode.dev/images/blog/react-wheel-picker.webp?t=1747747932
...
Built on top of [React Wheel Picker](https://react-wheel-picker.narakcode.dev) – Backed by ▲Vercel OSS Program.
...
```bash
npx shadcn@latest add @nrcode/wheel-picker
```
...
```bash
npm install @nrcode/react-wheel-picker clsx tailwind-merge
```
