...
image: https://assets.narakcode.dev/images/blog/fluid-gradient-text.webp
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/fluid-gradient-text.json"
  customizeUrl="https://narakcode.dev/preview/fluid-gradient-text-dialkit"
/>
...
```bash
npx shadcn@latest add @nrcode/fluid-gradient-text
```
