...
image: https://assets.narakcode.dev/images/blog/icon-swap.webp?t=1779078388
...
<ComponentPreview
  name="icon-swap-demo"
  openInV0Url="https://narakcode.dev/r/icon-swap.json"
/>
...
```bash
npx shadcn@latest add @nrcode/icon-swap
```
