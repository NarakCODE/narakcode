...
image: https://assets.narakcode.dev/images/blog/work-experience-component.webp?t=1779078388
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/work-experience.json"
  prose
/>
...
```bash
npx shadcn@latest add @nrcode/work-experience
```
