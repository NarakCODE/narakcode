...
image: https://assets.narakcode.dev/images/blog/code-block-command.webp?t=1779078388
...
<ComponentPreview
  ...
  openInV0Url="https://narakcode.dev/r/code-block-command.json"
/>
...
```bash
npx shadcn@latest add @nrcode/code-block-command
```
...
- [Copy Button](https://narakcode.dev/components/copy-button)
