...
image: https://assets.narakcode.dev/images/blog/twemoji.webp
...
<ComponentPreview
  name="twemoji-demo"
  openInV0Url="https://narakcode.dev/r/twemoji.json"
/>
...
```bash
npx shadcn@latest add @nrcode/twemoji
```
...
[lib/twemoji-regex.ts](https://github.com/narakcode/chanhdai.com/blob/main/src/registry/components/twemoji/lib/twemoji-regex.ts)
